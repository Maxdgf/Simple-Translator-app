...
class MyApp(tk.Tk):    
    ...
    def selectFile(self):
    	try:
            ...
            messagebox.showerror("Error", "Please, chek a file format, must have txt format and try again.")
    ...
    def startTranslate(self):
               try:
               	...
               	self.translate = self.translator.translate(self.textValue, dest=self.langValue).text
               	#print(self.translate)
               	self.outputField.delete("1.0", "end")
               	self.outputField.insert("end", self.translate)
               except Exception as e:
               	messagebox.showerror("Error", "Please, chek input field, language\nvalue and internet connection")
               	#print("error: ", e)                                                                                              
